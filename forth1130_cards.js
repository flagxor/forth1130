...
OPERATION /  FF LS  1890 DEPOSIT  0 DIV FS  FF SS XCH 0 SS  RETURN
OPERATION *  FF LS  0 MUL FS  XCH  FF MS  0 SS RETURN

OPERATION PUSH  0 LSI  ADD 1 ACC  0 SSI  0 SS  FF LS  0 SSI
   FE MS  RETURN
OPERATION PULL  0 LSI 1 SS SUB 1 ACC 0 SSI 1 LSI 0 SS RETURN
...
.RED  900,  .BLACK  500,
OPERATION RIBBON  0 LS  FF MS  LOC TYP CALL LD 8100 ACC
  LOC TYP CALL  RETURN
OPERATION TYPE
...
OPERATION BLANK  0 M ST  1 TOD  FF CS  LX X3 GOR LT
   9 TR  0 M ST  1 TOD  1 SUB LT  5 TR  2424 M LT  0 MARK
      0 TA  LOOP  RETURN
...
OPERATION REMEMBER  LOC ENTRY CALL
   LOC FORGET M LT  2 X2 TR  IC M MT  3 X3 TR  RETURN
...
: BYE  1 PRINT ,
: DIGIT 0F AND EMIT ,
: HALF 2 / DROP 7FFF AND ,
: SIXF DUP 0F AND SWAP HALF HALF HALF HALF ,
...
OPERATION TT   LOC NN CALL  RETURN
